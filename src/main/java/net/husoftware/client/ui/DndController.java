...
import net.husoftware.client.model.DndDelegate;
import net.husoftware.client.model.DndDelegateNoop;
...
public class DndController<I extends IsWidget> extends DndDelegateNoop<I>
{
  ...
  private void addAttribute(I inItem, int inPos)
  {
    if (mOnMouseMoveAttribute)
    {
      inItem.asWidget().getElement()
          .setAttribute("onmousemove", "onMouseMove(event, '" + inPos + "')");
    }
    if (mOnDropAttribute)
    {
